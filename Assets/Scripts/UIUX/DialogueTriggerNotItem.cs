...
public class DialogueTriggerNotItem : MonoBehaviour
{
	...
	private float nextTime = 0.5f; // used with waitTime to create a timer system
	...
	private void Start()
	{
		...
		// if(!willDisappearLater)
		//     GameEventSys.current.onItemInteract += ShowDialogue;
	}
